...
// 0.1.0: centralized panel listing every loaded plugin and surfacing the
...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-plugin-config-editor-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE

    manifest {
        attributes(
            "Implementation-Title" to "BOSS Plugin Config Editor Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.cfg.PluginCfgDynamicPlugin"
        )
    }
